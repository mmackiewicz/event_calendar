...
def is_secretary():
    def has_secretary_role(u):
        return u is not None and u.is_authenticated() and u.get_profile().role == models.ROLE_SECRETARY
    return user_passes_test(has_secretary_role)
